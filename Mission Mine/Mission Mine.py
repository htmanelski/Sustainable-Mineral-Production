...
def Cycl1():
    ...
    g1 = ImageTk.PhotoImage(Image.open(image))
    graph1_label = Label(foreground, image=g1).place(x=1100, y=400)
...
def Cycl2():
    ...
    g2 = ImageTk.PhotoImage(Image.open(image))
    graph2_label = Label(foreground, image=g2).place(x=1100, y=600)
...
ratio1_label = Label(foreground, text= "O/F U/F Ratio:")
ratio2_label = Label(foreground, text= "O/F U/F Ratio:")
